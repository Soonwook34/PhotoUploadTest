...
- **사진/동영상 업로드** - 1인당 최대 50개, 이미지 자동 압축
- **실시간 갤러리** - 하객들이 올린 사진을 바로 확인
- **모바일 최적화** - 스마트폰 환경에 맞춘 UI/UX
- **라이트박스** - 사진 전체화면 보기, 스와이프 네비게이션
...
### 갤러리 페이지
- 전체 / 사진 / 영상 필터
- Masonry 스타일 그리드 레이아웃
- 전체화면 라이트박스 (터치 스와이프 지원)
- "더 보기" 페이지네이션 (20개씩)
...
| 이미지 최대 크기 | 50 MB |
| 동영상 최대 크기 | 200 MB |
| 허용 파일 형식 | 이미지 (jpg, png, heic 등), 동영상 (mp4, mov 등) |
| 이미지 자동 압축 | 500KB 이상 시 최대 1920px, JPEG 80% |
| 동시 업로드 | 3개씩 |
